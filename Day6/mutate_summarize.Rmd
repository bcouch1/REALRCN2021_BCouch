...
The data do not support the anecdotes.
...
edu_dat %>%
  ...
  summarise(final_mean = mean(final_exam, na.rm = T))
```

***Pause and make sure you can state these results in a single-sentence. ***
Students who got the first multiple choice question wrong had a higher mean final exam score.
